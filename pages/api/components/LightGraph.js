...
export default function LightGraph({ data, lineColor, fillGraph, selectedDate, title, makeGraph, tension }){
  ...
  if(data == null){
    ...
    if (columns.length >= 2) {
        ...
        const secondColumnValue = columns[6];
            ...
            datasets: [
                {
                  ...
                  pointRadius: 0, // 작은 크기로 조절
                  pointBackgroundColor: "rgba(255, 99, 132, 1)",
                  pointBorderColor: "rgba(255, 255, 255, 1)",
                  pointBorderWidth: 0, // 테두리 두께 조절
                  pointHoverRadius: 10, // 호버 시 크게 나타나도록
              ...
              tooltip: {
                ...
                callbacks: {
                  ...
                  label: function(context) {
                    return context.formattedValue + "W/m^2";
                  },
                },
              },
